...
import { useNavigate } from "react-router-dom"; // ✅ This is the missing line
            ...
            <div className="course-header">
                ...
                <div className="back-link">
                    <div className="chevron">
                        <img src="../src/assets/chevron_backward.png" alt="chevron_backward" />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="description-text">
                            <p>
                                ...
                                Python and related technologiesboth front-end and back-end components of web applications using
