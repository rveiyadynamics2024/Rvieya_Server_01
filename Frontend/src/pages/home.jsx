    ...
    <>
      <div className="home-section1">
        <div className="home-sec-part1">
          ...
          <p>
            At <strong>"RVEIYA DYNAMICS"</strong>, we specialize in providing
            industry-relevant
            <br />
            courses and internships for students, taught by experienced
            professionals
            <br />
      ...
      <div className="home-section3">
        ...
        <p className="home-who-desc">
          RVEIYA DYNAMICS PVT LTD is a Skill Development and EdTech company,
          established on 21st November 2024, and approved by Startup India and
          MSME. We specialize in providing affordable, flexible, and
          industry-relevant educational solutions through live online classes,
          internships, mentorship programs, and project based learning for
          students in BTech, MTech, BBA, BCA, and general degree programs. Our
          offerings include both software courses such as C-Language, Python,
          Full Stack Development, Machine Learning, and hardware courses like
          Embedded Systems and VLSI, all tailored to bridge the gap between
          academic education and real-world industry demands. With a mission to
          make high-quality education accessible, we focus on practical learning
          and job readiness, equipping students with the skills they need to
          succeed in today’s competitive job market.
        </p>

        <h4 className="home-service-heading home-color">
          We are offering the below services:
        </h4>
        <div>
          <p className="home-who-descc">
            RVEIYA DYNAMICS PVT LTD is committed to empowering students with
            industry relevenat skillsand practical experience through a
            comprehensive range of services and features
          </p>
        </div>

        <ul className="home-service-list">
          <li>
            Affordable Courses: Access high-quality, industry-aligned training
            at cost-effective prices.
          </li>
          <li>
            Flexible Payment Plans: Make education more accessible with
            convenient, term-wise installment options.
          </li>
          <li>
            Live Online Classes: Engage in interactive, real-time learning.
          </li>
          <li>
            Internship Opportunities: Apply classroom knowledge in real-world
            scenarios.
          </li>
          <li>
            Project-Based Learning: Build your portfolio with live,
            industry-grade projects.
          </li>
          <li>
            One-on-One Mentorship: Personalized career guidance and support.
          </li>
          <li>
            Industry-Recognized Certifications: Enhance employability with
          ...
          <li>
            ...
            <ul>
              <li>
                Software: C Programming, Python, Full Stack Development, Machine
                Learning
              </li>
      ...
      <div className="home-section4">
        <div className="home-heading-row">
          <h3>
            <span>Courses </span>We Offer
          </h3>
          <div className="home-view-all" onClick={() => navigate("/courses")}>
            <a href="">View All</a>
          </div>
        </div>
                ...
                <div className="home-dff">
                  ...
                  <div className="home-time_money">
                    <p className="home-duration">
                      <img src={timerIcon} alt="duration" />3 Months
                    </p>
                  </div>
                </div>
                <p className="home-price">{course.price}</p>
                <div className="reg-btns">
                  <Link to="/courseview/1" className="home-register-btn">
                    Register Now →
                  </Link>
                </div>
              </div>
        ...
        <div className="home-heading-row">
          <h3>
            <span>Internships </span> We Offer
          </h3>
          <div
          ...
          {[
            ...
            <div className="home-card" key={index}>
              ...
              <div className="home-card-body">
                ...
                <div className="reg-btns">
                  <Link to="/courseview/2" className="home-register-btn">
                    Register Now →
                  </Link>
                </div>
              </div>
        ...
        <div className="home-headlinee">
          <div>
            {" "}
            <h3>
              <span>Testim</span>onials
            </h3>
          </div>
          <div className="home-view-all" onClick={() => navigate("/testimonials")}>
            <a href="">View All</a>
          </div>
        </div>
        <div className="home-container">
          <div className="home-testheader">
            ...
            <div className="home-paragraph">
              <p>
                I have invested considerable time researching various online
                platforms, its course offerings, learning programs, instructor
                quality, pricing structures, refund policies, as well as
